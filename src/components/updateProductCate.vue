<template>
    <div class="updateProductCate">
        <el-form v-model="formData" size="small" label-position="right" label-width="auto" :rules="rules"
            ref="ruleForm">
            ...
            <el-form-item label="属性筛选：">
                <div v-for="(item, index) in Attributes" :key="index" style="margin-top:10px">
                ...
                <el-button type="primary" size="small" style="margin-top:20px" @click="add">新增</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
